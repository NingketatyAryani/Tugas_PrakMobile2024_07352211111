...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/pict4.jpg"
    },
    {
      "name": "Makeup",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/pict6.jpg"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/pict4.jpg',
          name: 'Beauty Shop',
          role: 'Electronik',
        ...
        ServiceCard(
          imageUrl: 'assets/images/pict8.jpg',
          name: 'Tentang Beauty',
          role: 'Desain',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
        ...
        ServiceCard(
          imageUrl: 'assets/images/pict5.jpg',
          name: 'Code Girl ',
          role: 'Pemrograman',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/pict7.jpg',
            profileUrl: 'assets/images/pict8.jpg',
          ...
          BestBookingCard(
            imageUrl: 'assets/images/pict3.jpg',
            profileUrl: 'assets/images/pict5.jpg',
            name: 'LOVELY',
            role: 'GIRLS',
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/pict2.jpg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
